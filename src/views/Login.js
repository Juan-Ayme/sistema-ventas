                    ...
                    <div className="card o-hidden border-0 shadow-lg my-5">
                        <div className="card-body p-0">
                            ...
                            <div className="col-lg-6 d-none d-lg-block" style={{ 
                                    backgroundImage: `url(${process.env.PUBLIC_URL}/imagen/tienda.png)`,
                                    backgroundSize: 'contain', // Esto hará que la imagen se ajuste al div, manteniendo su aspecto
                                ...
                                <div className="col-lg-6">
                                    <div className="p-5">
                                        ...
                                        <form className="user" onSubmit={handleSubmit}>
                                            ...
                                            <button type="submit" className="btn btn-info btn-user btn-block"> Ingresar </button>
